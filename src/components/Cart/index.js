...
import squarePluseIcon from "../../assets/images/icons/square-plus-icon.svg";
import squareMinusIcon from "../../assets/images/icons/square-minus-icon.svg";
        ...
        <div class="cart-product__price-wrap">
          <div class="cart-counter">
            ...
            <button type="button" class="cart-counter__button cart-counter__button_plus">
              <img src="${squarePluseIcon}" alt="plus">
            </button>
          </div>
